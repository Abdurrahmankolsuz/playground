...
{<img src="https://travis-ci.org/regularlambda/aldebaran.png" />}[http://travis-ci.org/regularlambda/aldebaran]
...
Then, in your project directory, create a +Gemfile+:
  ...
  source :rubygems
  gem 'aldebaran', :git => "git://github.com/regularlambda/aldebaran.git"
...
on the <tt>$LOAD_PATH</tt>:
  ...
  cd myapp
  git clone git://github.com/regularlambda/aldebaran.git
  ruby -I aldebaran/lib myapp.rb
