...
static int direction_map[n][m]; // map of directions
const int directions=8; // number of possible directions to go at any position
// if dir==4
...
public:
    ...
    {
        level+=(directions==8?(i%2==0?10:14):10);
    }
        ...
        for(i=0;i<directions;i++)
        {
                 ...
                 || closed_nodes_map[xdx][ydy]==1))
            {
                ...
                if(open_nodes_map[xdx][ydy]==0)
                {
                    ...
                    direction_map[xdx][ydy]=(i+directions/2)%directions;
                }
