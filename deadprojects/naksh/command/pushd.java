...
public class pushd extends Command
{
    ...
    public void usage()
    {
        ...
        out().println("    If no directory is specified, then the current\n"+
                      ...
                      "    variables naksh.dir and naksh.dir_stack\n"+
                      "    are modified.");
    }
    ...
    private void swap_current_and_top()
    {
        ...
        String current_dir = property("naksh.dir");
        if (dir_stack == null)
        ...
        else
        {
            ...
            if (space > 0)
            {
                ...
                property("naksh.dir", top);
                property("naksh.dir_stack", current_dir + remainder);
            }
            else
            {
                property("naksh.dir", dir_stack);
                property("naksh.dir_stack", current_dir);
            }
