...
// (i.e., you'd see them in a stack trace between naksh.Naksh
// and a command class such as command.ls):
...
// of a command line, and the reflect the structure of Naksh syntax.
...
public class CommandLineInterpreter extends PooledThread
{
        ...
        throws Exception
    {
        ...
        if (exceptions.size() > 0)
            throw new NakshException(exceptions);
    }
