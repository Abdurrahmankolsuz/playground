...
public abstract class Command
{
    ...
    protected final PrintStream out()
    {
        if (_out == null)
        {
            ...
            if (System.getProperty
                (Naksh.NAKSH_BUFFER).equals("true"))
                _out = new MultilineBufferPrintStream(_out);
            if (System.getProperty
                (Naksh.NAKSH_PAGE).equals("true"))
    ...
    {
        return arg.charAt(0) ==
               Util.systemProperty(Naksh.NAKSH_FLAG).charAt(0);
    }

    protected String flag(String arg)
    {
        return Util.systemProperty(Naksh.NAKSH_FLAG) + arg;
    }
