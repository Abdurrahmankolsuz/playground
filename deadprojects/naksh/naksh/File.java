...
public abstract class File extends java.io.File
{
    ...
    {
        return Naksh.os().createFile(path);
    }

    public static File create(String directory, String file_name)
    {
        return Naksh.os().createFile(directory, file_name);
    }


    // naksh.File interface

    public FileInputStream inputStream()
        throws IOException
    {
        String absolute_naksh_path = _path.absolutePath();
        String absolute_os_path = Path.nakshToOs(absolute_naksh_path);
    ...
    protected File(String path)
    {
        ...
        super(Path.nakshToOs(Path.create(path).absolutePath()));
