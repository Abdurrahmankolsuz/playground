...
// Used by naksh.File to keep track of stated paths (i.e. from the
...
public class Path
{
    ...
    public static String nakshToOs(String naksh_path)
    {
        return Naksh.os().nakshToOsPath(naksh_path);
    }

    public static String osToJshell(String os_path)
    {
        return Naksh.os().osToJshellPath(os_path);
    }
    ...
    public String canonicalPath()
        throws IOException
    {
        return Naksh.os().canonicalizePath
    ...
    private Path(String path)
    {
        ...
        if (last_slash < 0)
        {
            ...
            _absolute_directory =
                System.getProperty(Naksh.NAKSH_DIR);
            _file_name = path;
        }
        ...
        else
        {
            ...
            _absolute_directory =
                absolute(path)
                ? _stated_directory
                : concatenate(System.getProperty(Naksh.NAKSH_DIR),
                              _stated_directory);
        }
    }
