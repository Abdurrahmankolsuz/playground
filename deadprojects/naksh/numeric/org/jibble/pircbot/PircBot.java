...
$Author: pjm2 $
$Id: PircBot.java,v 1.33 2004/03/04 23:06:32 pjm2 Exp $
...
public abstract class PircBot implements ReplyConstants {
    ...
    public final synchronized void connect(String hostname, int port, String password) throws IOException, IrcException, NickAlreadyInUseException {
        ...
        if (isConnected()) {
            throw new IOException("The Numeric is already connected to an IRC server.  Disconnect first.");
        }
    ...
    protected void handleLine(String line) {
        ...
        if (command.equals("PRIVMSG") && line.indexOf(":\u0001") > 0 && line.endsWith("\u0001")) {
            ...
            this.addUser(channel, new User("", sourceNick,sourceLogin, sourceHostname));
        ...
        if (_channelPrefixes.indexOf(target.charAt(0)) >= 0) {
            ...
            for (int i = 0; i < params[0].length(); i++) {
                ...
                if (atPos == '+' || atPos == '-') {
                    ...
                    if (pn == '+') {
                        this.addUser(channel, new User("@", params[p], sourceLogin, sourceHostname));
    ...
    private String _name = "Numeric";
    private String _nick = _name;
    private String _login = "Numeric";
    private String _version = "STFU what r u lookin 4 lam3r?" + VERSION + "Numeric IRC Bot - https://launchpad.net/numeric";
    private String _finger = "Pandik attigin icin tutuklanacaksin!";
