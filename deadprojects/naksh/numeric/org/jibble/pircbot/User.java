...
$Author: pjm2 $
$Id: User.java,v 1.21 2004/02/29 01:20:37 pjm2 Exp $
...
public class User {
    ...
    /**
     * Constructs a User object with a known prefix and nick and the extra login and hostname info.
     *
     * @param prefix The status of the user, for example, "@".
     * @param nick The nick of the user.
     * @param login The login of teh user.
     * @param hostname The hostname of the user.
     */
    User(String prefix, String nick, String login, String hostname) {
        _prefix = prefix;
        _nick = nick;
